...
from Day_10_MOCKI.exercise_7_mocks_products_and_cart.cart import Cart
...
class TestCart(unittest.TestCase):
    ...
    def test_compute_sum(self):
        ...
        self.cart.add_product(first_mock)
        self.cart.add_product(second_mock)
        self.assertEqual(self.cart.compute_sum(), expected)
        first_mock.get_price.assert_called_once()
        second_mock.get_priceassert_called_once()
